...
Uso:
    python3 03_reconciliacion_grc_importe_vs_poliza_ceco.py --fecha-ini 2026-01-01 --fecha-fin 2026-02-01
"""
import argparse
import sys
...
def main():
    ...
    comp.to_csv(f"03_reconciliacion_grc_importe_vs_poliza_ceco_{fi}_{ff}.csv", index=False)
    console.print(f"\n[green]Guardado: 03_reconciliacion_grc_importe_vs_poliza_ceco_{fi}_{ff}.csv[/green]")
