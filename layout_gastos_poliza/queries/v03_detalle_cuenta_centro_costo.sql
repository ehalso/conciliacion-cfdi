...
SELECT
    -- Gr_Folio YA es el folio completo de display tal cual lo ve el
    -- usuario en MPRO ("SS-NNNNNNN", sucursal 2 digitos + folio 7
    -- digitos, varchar(10) fijo) -- no reconstruir concatenando
    -- Sc_Cve_Sucursal (ese catalogo guarda la sucursal con 4 digitos,
    -- "00"+2, un formato DISTINTO que no corresponde al folio de
    -- display). Confirmado 2026-09-03 sin excepciones sobre el
    -- universo completo. Sc_Cve_Sucursal solo sirve aqui para el JOIN
    -- a Sucursal y el filtro de empresa.
